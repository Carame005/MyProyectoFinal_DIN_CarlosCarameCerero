...
Este documento contiene dos secciones diferenciadas: una guía práctica dirigida al usuario asistido y otra dirigida al tutor. Ambas están en el mismo archivo para facilitar la revisión.
...
- Sección para el tutor
  - Introducción rápida para tutores
  - Acceso a la pantalla Tutor
  - Visualización de tutorizados (cards)
  - Gestión de tareas/eventos/videos para tutorizados
  - Generación y exportación de informes por tutorizado
  - Restricciones y consideraciones (qué no puede hacer el tutorizado)
...
### Introducción rápida para tutores
Esta sección explica las funciones adicionales que los tutores tienen disponibles para gestionar a sus tutorizados: ver su actividad, añadir tareas/eventos/videos y generar informes.

### Acceso a la pantalla Tutor
- Desde la barra inferior (o menú de navegación), acceder a la opción "Tutor" para abrir la `TutorPantalla`.
- En esa pantalla se muestran cards con los usuarios tutorizados y una imagen de perfil si la tienen.

### Visualización de tutorizados (cards)
- Cada tutorizado aparece como una card con foto y nombre.
- Pulsar una card la expande para mostrar sus tareas, eventos y colecciones.
...
- Revisar semanalmente los informes generados para ajustar tareas y recordatorios.
- Preferir añadir horas concretas en eventos si desea recibir notificaciones exactas.
- Usar la exportación TXT para archivar actividad o compartir con familiares/profesionales.
