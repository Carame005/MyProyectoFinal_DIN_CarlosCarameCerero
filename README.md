...
- RA4 (Usabilidad, estándares y evaluación):
  ...
  - RA4.c (menús): ver [utils/Componentes.kt](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/utils/Componentes.kt) (`AppTopBar` / `SettingsDrawer`) y `COMPONENTS.md`. (Evidencia: estructura de menús y accesos.)
