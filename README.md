...
- RA5 (Informes):
  ...
  - RA5.f (uso de herramientas para generar informes): ver [`INFORMES.MD`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/INFORMES.MD) y `app/src/main/java/.../utils/ReportGenerator.kt`. (Evidencia: `buildReportText`, `buildReportSummary`, `saveReportToCache` y `getUriForFile` — generación, resumen y exportación.)
  - RA5.g (modificación del código del informe): ver `app/src/main/java/.../utils/ReportGenerator.kt`, `app/src/main/java/.../utils/ReportChart.kt` y las integraciones en `app/src/main/java/.../pantallas/HomePantalla.kt` y `app/src/main/java/.../pantallas/TutorPantalla.kt`. (Evidencia: adaptaciones en código para construir informes, generar gráficos y exponer opciones de copia/compartir.)
  - RA5.h (app con informes integrados): ver `app/src/main/java/.../pantallas/HomePantalla.kt` y `app/src/main/java/.../pantallas/TutorPantalla.kt` y las capturas en `documentacion/capturas/` (`menuHome.jpeg`, `menuTutorInforme.jpeg`, `informeGenerado.jpeg`). (Evidencia: flujo UI completo — filtros, informe en pantalla, gráfico y exportación.)  
