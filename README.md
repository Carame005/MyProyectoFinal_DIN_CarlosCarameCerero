...
- Documentación (carpeta [documentacion/](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/tree/master/documentacion)):
  ...
  - [BACKEND_MANUAL.md](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/BACKEND_MANUAL.md) — Manual técnico del backend local (persistencia, repositorios, alarmas, exportes).
...
- RA1 (Interfaz y desarrollo):
  ...
  - RA1.e (análisis del código - implementación técnica): además, consultar [`BACKEND_MANUAL.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/BACKEND_MANUAL.md) para detalles sobre persistencia, repositorio, alarmas y diseño de la capa de datos.
...
- RA2 (NUI - Interfaces naturales):
  - RA2.a (herramientas NUI): ver [`NUI.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/NUI.md) y [BiometricHelper.kt](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/security/BiometricHelper.kt). (Evidencia: identificación de biometría, voz y detección como opciones y referencias a APIs.)
...
- RA4 (Usabilidad, estándares y evaluación):
  ...
  - RA4.f (elección de controles): ver [`DESIGN_JUSTIFICATION.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/DESIGN_JUSTIFICATION.md) y [`COMPONENTS.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/COMPONENTS.md). (Evidencia: justificación de tipos de control y su adecuación.)
  - RA4.g (diseño visual): ver [`USER_MANUAL.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/USER_MANUAL.md) y [`capturas/`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/tree/master/documentacion/capturas) (capturas de pantalla). (Evidencia: apariencia y contraste en las pantallas principales.)
...
- RA5 (Informes):
  ...
  - RA5 (implementación técnica y exportación): para la implementación y detalles de exportación/guardado ver también [`BACKEND_MANUAL.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/BACKEND_MANUAL.md).
  ...
  - RA5.f (uso de herramientas para generar informes): ver [`INFORMES.MD`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/INFORMES.MD) y [ReportGenerator.kt](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/utils/ReportGenerator.kt). (Evidencia: `buildReportText`, `buildReportSummary`, `saveReportToCache` y `getUriForFile` — generación, resumen y exportación.)
  - RA5.g (modificación del código del informe): ver [ReportGenerator.kt](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/utils/ReportGenerator.kt), [`ReportChart.kt`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/utils/ReportChart.kt) y las integraciones en [`HomePantalla.kt`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/pantallas/HomePantalla.kt) y [`TutorPantalla.kt`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/pantallas/TutorPantalla.kt). (Evidencia: adaptaciones en código para construir informes, generar gráficos y exponer opciones de copia/compartir.)
  - RA5.h (app con informes integrados): ver [`HomePantalla.kt`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/pantallas/HomePantalla.kt) y [`TutorPantalla.kt`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/app/src/main/java/com/example/myproyectofinal_din_carloscaramecerero/pantallas/TutorPantalla.kt) y las capturas en [menuHome.jpeg](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/capturas/menuHome.jpeg),[menuTutorInforme.jpeg](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/capturas/menuTutorInforme.jpeg) y [informeGenerado.jpeg](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/capturas/informeGenerado.jpeg).(Evidencia: flujo UI completo — filtros, informe en pantalla, gráfico y exportación.)  
...
- RA6 (Ayudas, manuales y documentación persistente):
  ...
  - RA6.d (estructura y detalles técnicos): consultar también [`BACKEND_MANUAL.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/BACKEND_MANUAL.md) para un resumen técnico de cómo se guardan y organizan los datos y recomendaciones para migración a Room/DataStore.
  ...
  - RA6.g (confección de tutoriales): ver [`USER_MANUAL.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/USER_MANUAL.md) (secciones de "primeros pasos" y flujo tutor),[`DEV_SETUP.md`](https://github.com/Carame005/MyProyectoFinal_DIN_CarlosCarameCerero/blob/master/documentacion/DEV_SETUP.md)(Explicacion de como desplegar el proyecto y requisitos) y el video explicativo de la app. (Evidencia: tutoriales básicos y pasos guiados.)
